...
Registrar as experiências dos integrantes da SubEquipe_02 com o uso de IA Generativa durante a realização das atividades da entrega, destacando as principais lições aprendidas, as contribuições da ferramenta e as limitações identificadas ao longo do processo.
...
**Todos os integrantes da SubEquipe_02 devem participar.**
