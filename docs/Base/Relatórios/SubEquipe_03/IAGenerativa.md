...
|:------:|:----:|:----------|:----------|:------------|:-------------------|
| 1.0 | 13/09/2026 | Criação do documento de IA Generativa da SubEquipe_03. | [Arthur Fernandes](https://github.com/arthurfernandesj) | [Guilherme Moura](https://github.com/Guilherme-Moura) | Criação da estrutura inicial para registro das lições aprendidas e do uso crítico de IA Generativa pelos integrantes. |
