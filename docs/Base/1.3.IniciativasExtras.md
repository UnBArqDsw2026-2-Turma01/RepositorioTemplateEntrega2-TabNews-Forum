...
| 1.2 | 17/09/2026 | Correção dos links de comprobatório. | [Caio Alexandre](https://github.com/bitterteriyaki) | [Arthur Fernandes](https://github.com/arthurfernandesj) | Substituição dos caminhos relativos por URLs absolutas do GitPages, de modo que os comprobatórios funcionem tanto na página publicada quanto na visualização dos arquivos pelo GitHub. |
